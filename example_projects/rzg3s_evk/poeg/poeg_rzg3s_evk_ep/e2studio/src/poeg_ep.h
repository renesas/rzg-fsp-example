...
/* Macro definition */
#define LED_PIN_POEG0 (BSP_IO_PORT_18_PIN_00)
#define LED_PIN_POEG1 (BSP_IO_PORT_13_PIN_04)
#define SET_FLAG    (1)
#define CLEAR_FLAG  (0)
...
{
    (uint16_t) BSP_IO_PORT_18_PIN_00,  ///< LED0
    (uint16_t) BSP_IO_PORT_13_PIN_04,  ///< LED1
};
