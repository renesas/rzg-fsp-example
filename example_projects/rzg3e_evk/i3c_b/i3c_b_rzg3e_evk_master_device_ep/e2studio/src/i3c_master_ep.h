...
#define EP_INFO                "This example project demonstrates the typical use of the I3C_B Driver as master\r\n"\
                               "on Renesas RZ MPUs based on Renesas FSP. The I3C master demonstrates operation\r\n"\
