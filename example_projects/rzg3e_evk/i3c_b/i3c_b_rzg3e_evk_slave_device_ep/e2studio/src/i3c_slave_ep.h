...
#define USER_SW_IRQ_NUMBER                       (0x0e)
...
#define LED0_PORT      (BSP_IO_PORT_06_PIN_05)
#define LED1_PORT      (BSP_IO_PORT_06_PIN_06)
#define LED2_PORT      (BSP_IO_PORT_05_PIN_06)
#define SWITCH_PORT    (BSP_IO_PORT_07_PIN_04)

#define EP_INFO                "This example project demonstrates the typical use of the I3C_B Driver as slave\r\n"\
                               "device on Renesas RZ MPUs based on Renesas FSP. once initialization is successful,\r\n"\
