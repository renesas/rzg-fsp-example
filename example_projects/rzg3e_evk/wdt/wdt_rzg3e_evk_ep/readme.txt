...
1. Project Overview:
    ...
    The operation of this example is as below:
      - Start GTM timer having a callback every 50 milliseconds, to refresh WDT and blink the led (LD2 on Pmod LED).
      - The WDT timeout is configured to 0.175 seconds.
