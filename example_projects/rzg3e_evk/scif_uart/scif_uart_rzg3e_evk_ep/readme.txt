...
1. Project Overview:
    The example project demonstrates the typical use of the SCIF_UART HAL module APIs.
...
3. Hardware settings:
    ...
    (4) Connect serial cable to SER3_UART port on SMARC Carrier Board to PC.
