...
void hal_entry (void)
{
    ...
    while(true)
    {
        /* Performs on riic slave read write operation */
        err = process_slave_WriteRead();

        /*
         * Perform clean_up - On riic slave read write operation failure
        ...
        {
            /* print RTT message */
            APP_ERR_PRINT ("\r\n **riic slave transaction Failed, closing open modules ** \r\n");
