...
/*******************************************************************************************************************//**
 * @brief     This function initialize the POEG6 module
 * @param[in] None
 * @retval    FSP_SUCCESS                  Upon successful POEG6 Open
 * @retval    Any Other Error code apart from FSP_SUCCESS  Upon Unsuccessful
 **********************************************************************************************************************/
fsp_err_t init_poeg6_module(void)
{
    fsp_err_t err = FSP_SUCCESS;
    /* Initializes the POEG. */
    err = R_POEG_Open(&g_poeg6_ctrl, &g_poeg6_cfg);
    return err;
}

/*******************************************************************************************************************//**
 * @brief     This function de-initialize the POEG6 module
 * @param[in] None
 * @retval    FSP_SUCCESS                  Upon successful POEG6 Close
 * @retval    Any Other Error code apart from FSP_SUCCESS  Upon Unsuccessful
 **********************************************************************************************************************/
fsp_err_t deinit_poeg6_module(void)
{
    fsp_err_t err = FSP_SUCCESS;
    /* Initializes the POEG. */
    err = R_POEG_Close(&g_poeg6_ctrl);
    /* Handle error */
    if(FSP_SUCCESS != err)
    {
        APP_ERR_PRINT("POEG 6 de-initialization failed\r\n");
    }
    else
    {
        APP_PRINT("POEG 6 de-initialization success\r\n");
    }
    return err;
}
