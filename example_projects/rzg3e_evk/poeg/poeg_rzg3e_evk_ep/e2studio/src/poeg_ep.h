...
#define POEG_CHANNEL_6 (2U)

/* Macro definition */
#define LED_PIN_POEG0 (BSP_IO_PORT_06_PIN_05)
#define LED_PIN_POEG6 (BSP_IO_PORT_06_PIN_06)
#define SET_FLAG    (1)
#define CLEAR_FLAG  (0)
...
#define EP_INFO                "\r\nThe example project demonstrates the basic functionalities of "\
                               "\r\nPOEG driver on Renesas RZG MPUs based on Renesas FSP.RZG MPUs is "\
...
{
    (uint16_t) BSP_IO_PORT_06_PIN_05,  ///< LED0
    (uint16_t) BSP_IO_PORT_06_PIN_06,  ///< LED1
};
